...
APP_URL="https://raw.githubusercontent.com/AkiHaza/Comet-Thread-Opt/main/app/App_common.txt"
GAME_URL="https://raw.githubusercontent.com/AkiHaza/Comet-Thread-Opt/main/game/Game_common.txt"
...
if [ -f "$CONFIG_FILE" ]; then
    get_cpu_val() {
        grep -F "$1" "$CONFIG_FILE" 2>/dev/null | head -n1 | cut -d= -f2- | tr -d '\r\n' || true
    }
